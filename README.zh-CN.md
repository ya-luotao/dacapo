...
- **曲目练习**：内置六首公版曲目，也可以导入自己的 MusicXML。等待模式下光标会等你弹对；节奏模式有节拍器，弹完告诉你偏早还是偏晚、在哪几小节越弹越快。示范和另一只手由你的乐器通过 MIDI 弹奏；乐器没有 MIDI 输出时，由内置的采样三角钢琴（Salamander Grand Piano）弹奏，电脑键盘和屏幕琴键也用它发声。
